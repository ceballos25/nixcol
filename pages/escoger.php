  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <!-- formulario de venta -->
        <div class="card-body">
          <h5 class="card-title fw-semibold mb-4">Generar una venta (Número premiado)</h5>
          <div class="card">
            <div class="card-body">

              <form class="row g-4 needs-validation" novalidate id="form-venta" action="../backend/processVenta2.php" method="POST">
                <div class="col-md-4">
...
.                    <option value="otro">Otro</option>
              ...
              <div class="d-flex justify-content-center align-items-center">
                <div class="col-6">
                  <label for="oportunidades" class="form-label">Numero Premiado</label>
                  <input type="number" value="" class="form-control" id="premiado" name="premiado" required min="5" />
                  <div class="invalid-feedback">Por favor, selecciona el número premiado</div>
                </div>
              </div>             
                      ...
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-6">
                            ...
                            <input type="number" value=" " class="form-control" id="total-oportunidades" name="total_numeros" readonly required min="4" />
        ...
        <script src="<?php echo JS_PATH; ?>vender.js"></script>
